...
import "./options-filter-model.less";
...
export class OptionsFilterPerformer extends PureComponent<IProps> {
  state = {
    q: "",
    l: 12,
    o: 0,
  ...
  render() {
    ...
    return (
      <div className="menu-option-filter-model">
        <Row>
          <Col md={24} xs={24} lg={24}>
            ...
            <Menu
              mode="inline"
              className="menu-options-items"
              onSelect={(item: any) => this.setState({ breastSize: item.key })}
            ...
            <br />
            <br />
            <Button onClick={() => this.handleClear()} className="btn-options">
              CLEAR
            </Button>
          </Col>
        </Row>
