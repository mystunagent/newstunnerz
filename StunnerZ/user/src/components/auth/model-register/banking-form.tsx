...
function BankingSettingRegister({
  formRef,
  onFinish
}: IProps) {
  const [form] = Form.useForm();
  const [type, setType] = useState('sepa');
  ...
  const renderBitsafeForm = () => (
    <>
      ...
      <Col span={24} style={{ textAlign: 'center', margin: 'auto' }}>
        <img src="/static/bitsafe-logo.png" alt="bitsafe-logo" style={{ maxWidth: '80vw' }} />
      </Col>
  ...
  return (
    <Form
      ...
      ref={formRef}
      {...layout}
      onFinish={(val) => onFinish({ ...val, type })}
      scrollToFirstError
      ...
      <Row>
        ...
        <Col span={24}>
          <Form.Item label="Select your bank transfer system">
            ...
            >
              <Option value="sepa" key="sepa">European and UK Bank Transfer</Option>
              <Option value="wire" key="wire">International Wire Transfer</Option>
...
export default BankingSettingRegister;
