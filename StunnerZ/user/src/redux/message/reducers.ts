...
const messageReducer = [
  ...
  {
    on: sendPaidContentMessageSuccess,
    reducer(state: any, data: IReduxAction<any>) {
      const nextState = { ...state };
      if (!nextState.conversationMap[data.payload.content.conversationId] || !nextState.conversationMap[data.payload.content.conversationId].items) {
        nextState.conversationMap[data.payload.content.conversationId].items = [];
      }
      nextState.conversationMap[data.payload.content.conversationId].items.push(
