...
import PayoutSubRequestList from '@components/payout-request/sub-table';

interface IProps {
  user: any
}

class SubPerformerPayoutRequestPage extends PureComponent<IProps> {
  ...
  async getData() {
    try {
      ...
      const resp = await payoutRequestService.subPerformerSearch({
        ...filter,
      ...
      <>
        ...
        <div className="main-container">
          ...
          <div style={{ margin: '10px 0' }}>
            <Button
              type="primary"
              onClick={() => Router.push('/sub-performer/payout-request/create')}
            >
              Request a Payout
            </Button>
          </div>
          <div className="table-responsive">
            <PayoutSubRequestList
              payouts={items}
              searching={loading}
...
export default connect(mapStateToProps)(SubPerformerPayoutRequestPage);
