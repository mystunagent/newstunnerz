...
const templateMap = {
  ...
  'performer-book-stream-confirmation': {
    name: 'Booking stream confirmation',
    subject: 'Booking Stream Confirmation',
    desc: 'Email to user when model confirmation'
  },
  'performer-booking-stream-reject': {
    name: 'Booking stream reject',
    subject: 'Booking Stream Reject',
    desc: 'Email to user when model reject'
  },
  'user-book-stream': {
    name: 'User Book Stream',
    subject: 'User Book Stream',
    desc: 'Email to performer when user book stream'
  },
  'booking-stream-reminder': {
    name: 'Booking Stream Reminder',
    subject: 'Booking Stream Reminder',
    desc: 'Email to model when user wait stream'
  },
  'booking-stream-confirmation': {
    name: 'Booking Stream Confirmation',
    subject: 'Booking Stream Confirmation',
    desc: 'Email to user when model stream'
  },
  'performer-has-booked-events': {
    name: 'Model book event confirmation',
    subject: 'Model book event confirmation',
    desc: 'Email to admin when model book stream'
  },
  'admin-created-event-success': {
    name: 'Admin create event success',
    subject: 'Admin create event success',
    desc: 'Email to own when create event success'
  },
  'admin-approved-booking-events': {
    name: 'Admin accept book event confirmation',
    subject: 'Admin accept book event confirmation',
    desc: 'Email to model of admin'
  },
  'admin-rejected-booking-event': {
    name: 'Admin rejected book event confirmation',
    subject: 'Admin rejected book event confirmation',
    desc: 'Email to model of admin'
  },
  'upcoming-stream-reminder': {
    name: 'Reminder notification for upcoming stream',
    subject: 'Reminder notification for upcoming stream',
    desc: 'Reminder notification for upcoming stream'
  },
  'user-upcoming-stream-reminder': {
    name: 'Reminder notification for user upcoming stream',
    subject: 'Reminder notification for user upcoming stream',
    desc: 'Reminder notification for user upcoming stream'
  },
  'account-agency-informations': {
    name: 'Agency Information',
    subject: 'Agency Information',
    desc: 'Agency Information'
  },
  'payout-agency-tokens': {
    name: 'Payout agency token',
    subject: 'Payout agency token',
    desc: 'Payout agency token'
  }
};
